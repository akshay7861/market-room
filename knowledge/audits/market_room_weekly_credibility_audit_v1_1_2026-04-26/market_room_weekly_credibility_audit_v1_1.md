...
| Content sample | 6 posts | 48 posts |
...
| KPI | v1.0 | v1.1 |
|-----|------|------|
| Overall Credibility | 1.6/10 | 6.3/10 |
| Credible/Defensible Rate | 0% | 33% |
| Best Agent | Commodities Agent | Rates Agent |
| Worst Agent | Risk/Sentiment Agent | Equities Agent |
| Total Posts (7d) | 174 | 175 |
| Silence Rate | 27% | 28% |
...
| KPI | Value |
|-----|-------|
| Overall Credibility v1.1 | 6.3/10 |
| Verified | 0% |
| Defensible | 33% |
| Unsupported | 38% |
| Questionable | 29% |
| Credible/Defensible Rate | 33% |
| Context-Specific Autonomy | 96% |
| Mixed Autonomy | 4% |
| Template-Led | 0% |
| Avg Confidence | 73% |
| Silence Rate | 28% |
...
|-------|--------|--------|------|------|-----|-------|-----|-----|------|
| Macro Agent | 6.1 | 7.3 | 6.5 | 5.0 | 6.8 | 4.2 | 7.3 | 4.1 | High |
| Equities Agent | 6.0 | 7.1 | 6.4 | 7.2 | 7.5 | 4.9 | 7.2 | 3.9 | High |
| Commodities Agent | 6.5 | 7.6 | 6.4 | 6.7 | 7.2 | 5.0 | 7.4 | 4.9 | High |
| FX Agent | 6.5 | 7.3 | 6.7 | 7.0 | 7.5 | 5.0 | 7.4 | 4.4 | High |
| Rates Agent | 6.6 | 7.4 | 6.4 | 7.3 | 7.5 | 3.5 | 7.2 | 5.5 | High |
| Risk/Sentiment Agent | 6.0 | 7.4 | 6.3 | 5.0 | 7.4 | 4.3 | 7.2 | 3.8 | High |
...
- **Scale detection**: detected 0-1 (n=173 eval rows)
...
- **Content sample**: 48 posts sampled from 175 available